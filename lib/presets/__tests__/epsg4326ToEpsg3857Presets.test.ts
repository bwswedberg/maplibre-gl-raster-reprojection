import { epsg4326ToEpsg3857Presets as presets } from "../epsg4326ToEpsg3857Presets";
...
describe("destinationTileToSourceTiles", () => {
  ...
  test.each(
    ...
    (_label, destinationTile, options, sourceTiles) => {
      const output = presets.destinationTileToSourceTiles(destinationTile, options?.zoomOffset);
...
describe("destinationToPixel", () => {
  test.each([
    [
      ...
      origin.meters,
      origin.case0.zoom,
      origin.case0.tileSize,
      origin.case0.destinationPixels
    ],
    [
      "origin z12",
      origin.meters,
      origin.case1.zoom,
      origin.case1.tileSize,
      origin.case1.destinationPixels
    ],
    [
      "origin z12 512",
      origin.meters,
      origin.case2.zoom,
      origin.case2.tileSize,
      origin.case2.destinationPixels
    ],
